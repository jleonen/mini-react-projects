  ...
  return (
    <div>
      <Tabs className={classes.tabsContainer}>
        <span onClick={itemManagementCtx.filterByName}>Name</span>
        {itemManagementCtx.action === "restock" ? (
          <span>Price per unit</span>
        ) : (
          <span onClick={itemManagementCtx.filterByQuantity}>Quantity</span>
        )}
        <span onClick={itemManagementCtx.filterByStatus}> Status </span>
        <span>Vendor </span>
        <div>
          <span>Actions</span>
          {choices}
